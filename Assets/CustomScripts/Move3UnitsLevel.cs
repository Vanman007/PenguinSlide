...
public class Move3UnitsLevel : MonoBehaviour {
	//cunit
	GameObject []CUnit = new GameObject[3];
	GameObject []CUPoint = new GameObject[3];
	Vector3 []CUnitVector = new Vector3[3];
	Vector3 []CUnitStart = new Vector3[3];
