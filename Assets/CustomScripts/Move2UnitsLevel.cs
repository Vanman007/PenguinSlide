...
public class Move2UnitsLevel : MonoBehaviour {
	//cunit
	GameObject []CUnit = new GameObject[4];
	GameObject []CUPoint = new GameObject[4];
	Vector3 []CUnitVector = new Vector3[4];
	Vector3 []CUnitStart = new Vector3[4];
