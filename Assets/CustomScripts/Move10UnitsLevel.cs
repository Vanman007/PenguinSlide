...
public class Move10UnitsLevel : MonoBehaviour {
	//cunit
	GameObject []CUnit = new GameObject[25];
	GameObject []CUPoint = new GameObject[25];
	Vector3 []CUnitVector = new Vector3[25];
	Vector3 []CUnitStart = new Vector3[25];
	float []time = new float[25];
	//punit
	GameObject []PUnit = new GameObject[48];
	GameObject []PUPoint = new GameObject[48];
	Vector3 []PUnitVector = new Vector3[48];
	Vector3 []PUnitStart = new Vector3[48];
	bool []PUnitIsRevers = new bool[48];
