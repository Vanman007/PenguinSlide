...
public class Move9UnitsLevel : MonoBehaviour {
	//cunit
	...
	//punit
	GameObject []PUnit = new GameObject[32];
	GameObject []PUPoint = new GameObject[32];
	Vector3 []PUnitVector = new Vector3[32];
	Vector3 []PUnitStart = new Vector3[32];
	bool []PUnitIsRevers = new bool[32];
