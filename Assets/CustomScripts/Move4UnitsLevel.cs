...
public class Move4UnitsLevel : MonoBehaviour {
	//cunit
	...
	//punit
	GameObject []PUnit = new GameObject[12];
	GameObject []PUPoint = new GameObject[12];
	Vector3 []PUnitVector = new Vector3[12];
	Vector3 []PUnitStart = new Vector3[12];
	bool []PUnitIsRevers = new bool[12];
