...
public class Move1UnitsLevel : MonoBehaviour {
	//cunit
	GameObject []CUnit = new GameObject[1];
	GameObject []CUPoint = new GameObject[1];
	Vector3 []CUnitVector = new Vector3[1];
	Vector3 []CUnitStart = new Vector3[1];
